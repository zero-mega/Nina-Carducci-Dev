(function (a) {
  (a.fn.mauGallery = function (t) {
    ...
    (a.fn.mauGallery.methods = {
      ...
      prevImage() {
        let currentSrc = a(".lightboxImage").attr("src");
        let images = a(".gallery-item");
        let currentIndex = images.index(images.filter(`[src="${currentSrc}"]`));
        let prevIndex = (currentIndex - 1 + images.length) % images.length;
        let newImageSrc = a(images.get(prevIndex)).attr("src");
        a(".lightboxImage").attr("src", newImageSrc);
    },
    ...
    nextImage() {
        ...
        let newImageSrc = a(images.get(nextIndex)).attr("src");
        a(".lightboxImage").attr("src", newImageSrc);
    }
    ,
